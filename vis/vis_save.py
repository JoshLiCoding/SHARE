...
def render_mesh_offscreen(frame, total_frames, meshes, xyz_limits, scene_vertices, scene_colors, width=640, height=480):
    ...
    renderer.setup_camera(60.0, center + [0, 0, -6], [pan_offset, -6, -2], [0, -1, 0])
...
def visualize_scene_and_joints(folder):
    ...
    if rendered_frames:
        ...
        output_path = f"{os.path.basename(folder)}_SHARE.mp4"
...
if __name__ == "__main__":
    ...
    parser.add_argument("folder", type=str, help="Folder containing share_scene.ply and share_vertices.npy")
